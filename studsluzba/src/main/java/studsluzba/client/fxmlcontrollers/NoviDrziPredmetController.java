...
@Component
public class NoviDrziPredmetController {
	
	@Autowired
	SifarniciService sifarniciService;
	
	@Autowired
	DosijeController sviNastavnici;
	...
	public void dodajNoviDrziPredmet(ActionEvent event) {
		...
		sviNastavnici.dodajDrziPredmet(drziPredmet);
	}
}
